...
Node *middleOfLL(Node *head)
{
    ...
    if (head == NULL)
    {
        return NULL; // Handle the case when head is null
    }
    ...
    // The two conditions are necessary as for the number of nodes
    // If nodes is even then -> fast != NULL
    // If nodes is odd then  -> fast->next != NULL

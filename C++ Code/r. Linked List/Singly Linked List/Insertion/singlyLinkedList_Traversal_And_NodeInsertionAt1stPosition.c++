...
int main() // MAIN DEFINATION
{
    ...
    Node *head = NULL;
    insertAtHead(head, 0); // Insert at the head of the linked list a new node with value 0
    display(head);

    insertAtHead(head, 1); // Insert at the head of the linked list a new node with value 1
    display(head);

    insertAtHead(head, 2); // Insert at the head of the linked list a new node with value 2
    display(head);

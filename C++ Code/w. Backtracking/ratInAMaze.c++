...
int ratInMaze(int i, int j, vector<vector<int>> &grid)
{
    ...
    // Base case: If the rat has reached the destination, return 1 (path found)
    if (i == n - 1 && j == n - 1)
    {
        return 1;
    }
...
int main() // Main function definition
{
    ...
    // Call the ratInMaze function to find and print the total number of paths
    cout << ratInMaze(i, j, grid) << endl;
